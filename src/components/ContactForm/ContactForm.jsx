    ...
    return (
        <div id="Contact" className=" max-w-[1400px] py-8  mx-auto min-h-[100vh]">
            <div className="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-12">
                ...
                >
                    <h2 className="mx-auto font-semibold text-xl lg:text-3xl font-montserrat pb-4">Contact Us</h2>
                    <p className='text-sm lg:text-xl py-2 font-poppins flex font-regular'><span className='font-semibold'></span> Suite 2,Wentworth Lodge, Great North Road, Welwyn Garden City, AL8 7SR</p>
                    <p className='text-sm lg:text-xl py-2 font-poppins flex font-regular'><span className='font-semibold'></span> 01707322748</p>
                    <p className='text-sm lg:text-xl py-2 font-poppins flex font-regular pb-6'><span className='font-semibold'></span> info@bethmar.co.uk</p>
                    <LocationMap />
                </motion.div>
                <motion.div
                    className="md:w-1/2"
